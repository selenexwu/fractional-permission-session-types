...
argument:
    | LPAREN; lp = label_proto RPAREN     { lp }
    ;
...
decl:
    ...
    | PROC; f = ID; COLON; args = args_opt; TURNSTILE; LPAREN; c = ID; COLON; t = proto; RPAREN; EQUALS; e = st  { (Ast.ExpDecDef(f, (args, (c,t)), e), Ast.make_ext $startpos $endpos) }
