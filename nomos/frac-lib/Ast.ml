...
and proto =
    Plus of choices                   (* +{...} *)
  | With of choices                   (* &{...} *)
  | Tensor of stype * proto           (* A *[m] B *)
  | Lolli of stype * proto            (* A -o[m] B *)
  | One                               (* 1 *)
  | PayPot of potential * proto       (* |> A  or  |{p}> A *)
  | GetPot of potential * proto       (* <| A  or  <{p}| A *)
  | TpName of tpname                  (* v *)
  | Up of proto                       (* /\ A *)
  | Down of proto                     (* \/ A *)
  ...
  | FArrow of func_tp * proto         (* t -> A *)
  | FProduct of func_tp * proto       (* t ^ A *)
  | FMap of func_tp * func_tp         (* Map<t,t> *)
  | STMap of func_tp * proto          (* Map<t,A> *)
  | Coin
[@@deriving sexp]
...
and 'a st_expr =
  ...
  | STMapCreate of chan * func_tp * proto  * 'a st_aug_expr                     (* $mp <- new Map<kt,vt>() *)
...
type decl =
  ...
  | ExpDecDef of expname * mode *
    ...
    parsed_expr
  | Exec of expname * arg list               (* exec f x1 x2 ... *)
[@@deriving sexp]
